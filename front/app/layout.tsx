...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body
        className={`${bitBit.variable} ${nexonGothic.variable} ${nexonGothic_Light.variable} ${nexonGothic_Medium.variable} ${nexonGothic_Bold.variable} ${neoDuggeunmo_Pro.variable}`}
      >
        {children}
      </body>
    </html>
